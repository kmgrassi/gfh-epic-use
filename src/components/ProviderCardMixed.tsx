...
import { MetricData, MetricWithStats, titleMap } from "../context/types";
...
export const ProviderCardMixed: React.FC<ProviderCardMixedProps> = ({
  ...
  const getMetricClass = (provider: MetricData | null, metricType: string) => {
    ...
    const threshold = useMedian
      ? metricStats.medianValue
      : metricStats.averageValue;
                ...
                {METRIC_ORDER.map((metricType) => {
                  ...
                  return (
                    <div key={metricType} className="provider-metric">
                      ...
                      <span
                        className={`provider-value ${getMetricClass(
                          provider,
                          metricType
                        )}`}
                      >
